...
function FoodList(props) {
    ...
    useEffect(() => {
        //step1: set loading restaurants as true;
    ...
    //fetch the menu of the current restaurant;
    useEffect(()=> {
        //step1: set loading menu as true;
        //step2: fetch the menu information from the server;
        if (curRest) {
            setLoading(true);
            getMenus(curRest)
                .then( response => {
            ...
            </Select>
            {
                curRest && (
                    <List
                        ...
                        grid={{
                            gutter: 16,
                            //sx, sm, md, etc represent different screen scales which will make the display self-adaptive;
                            xs: 1,
                            sm: 2,
                            md: 4,
                            lg: 4,
